MESSAGES_ENG = {
    ...
    "start_bot_authorize": "Hi {}, this is an IT teacher bot. Let's authorize you in to your Codewars account to make your experience smooth and easy 👇",
    "load_challenges_intro": "Let's steal some challenges from a codewars user.\n\nType a codewars username:",
    "load_challenges_count": "{} challenges. This is the exact number of challenges we're going to steal (sorry, save) from user {}.\n\nIt might take some time, be patient...\n\nLet's get started...",
    ...
    "random_task_on_screen_answer": "You chose {}",
    "random_task_found": "You selected level: {}\n\n{}",
    'task_name': "Challenge name:  {}",
    'task_description': "Description:  {}",
    'task_rank': "Rank:  {}",
    'task_url': "Codewars link:  {}", 
    "message_is_too_long": "Sorry, the description is too long, and telegram restrictions won't let us send it. Go to codewars to see the full description.",
    ...
    "load_tasks_error": "There was an error while loading tasks.\n\nMaybe you have typed wrong username, or this user does not have any completed challenges?",
